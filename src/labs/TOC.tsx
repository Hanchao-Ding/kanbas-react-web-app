...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills" id="wd-toc">
      ...
      <li className="nav-item"><a id="wd-a1" href="#/Labs/Lab4"
          className={`nav-link ${pathname.includes("Lab4") ? "active" : ""}`}>Lab 4</a></li>
      <li className="nav-item"><a id="wd-a2" href="#/Labs/Lab5"
      ...
      <li className="nav-item"><a id="wd-github" href="https://github.com/Hanchao-Ding" target="_blank"
